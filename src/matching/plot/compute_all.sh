...
python3 compute_alignment_performance.py -m tvshow-novels -s semantic
...
python3 compute_alignment_performance.py -m tvshow-comics -s semantic
...
python3 compute_alignment_performance.py -m comics-novels -s semantic
